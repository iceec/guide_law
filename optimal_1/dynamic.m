...
function [dr,dq,ddelt_m,ddelt_t,am,dz1,dz2] = dynamic(vm,vt,r,q,delt_m,delt_t,z1,z2,am_pre,t)
...
at = -5 * 9.81 * sin(t); %这个值 可以考虑以后从测量获取过来
...
[dz1,dz2] = eso(z1,z2,r,dr,delt_m,q,dq,am_pre);
