...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&dynamic_atexit);
  // Module initialization.
  dynamic_initialize();
  // Dispatch the entry-point.
  unsafe_dynamic_mexFunction(nlhs, plhs, nrhs, prhs);
  // Module termination.
  dynamic_terminate();
}
...
//
// File trailer for _coder_dynamic_mex.cpp
//
// [EOF]
//
